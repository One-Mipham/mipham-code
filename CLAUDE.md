...
测试：3,188 测试（3,186 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 79      | 1305     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| agent           | 11      | 120      | sub-agent / background-registry / pattern-analyzer / effectiveness-tracker                                                                                                  |
...
| **合计**        | **265** | **3188** | **0 失败** ✅（3186 passed + 2 skipped）                                                                                                                                    |
