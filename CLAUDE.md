...
> **产品**: 多模型开源智能编程终端
> **版本**: 2.36.0
> **最后更新**: 2026-09-12 — v0.80.0 发版（升级 Ink 5→7 + React 18→19，修欢迎屏 banner 间歇重复）
...
| 版本   | 日期       | 变更内容                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | 维护人     |
| ------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- |
| 2.36.0 | 2026-09-12 | v0.80.0 发版：升级 `ink 5.2.1→7.1.1` + `react 18.3.1→19.3.0`（`react-devtools-core`→8、`@types/react`→19），修欢迎屏 banner 间歇重复（根因 = Ink 5.2.1 输出层 diff bug，上游 issue #909 同类）。附带 `keyToEditAction` 区分 `key.backspace`(\x7f 退格) 与 `key.delete`(\x1b[3~ 前删)。测试 2244 passed + 2 skipped（2246 总，206 文件）。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 技术委员会 |
