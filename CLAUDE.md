...
> **产品**: 多模型开源智能编程终端
> **版本**: 2.9.1
> **最后更新**: 2026-08-23 — 可选打磨：agents 视图 Ctrl+X 永久删除会话 + 测试数对齐 1758
...
测试：1,758 测试（1756 passed + 2 skipped）
...
| **合计** | **152** | **1758** | **0 失败** ✅（1756 passed + 2 skipped）      |
