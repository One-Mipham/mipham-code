...
测试：3,248 测试（3,246 passed + 2 skipped，0 失败）
...
| daemon          | 35      | 224      | feishu / telegram / 钉钉 / 企业微信渠道 + session / auth / auth-rotate / workspace-guard / logger + **引擎接线行为**（`engine-capabilities`）                               |
...
| **合计**        | **270** | **3248** | **0 失败** ✅（3246 passed + 2 skipped）                                                                                                                                    |
