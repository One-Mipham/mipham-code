...
测试：3,369 测试（3,367 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 83      | 1335     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| mcp             | 10      | 105      | client / transport / oauth / token-store / registry / instructions（含 2 skipped）                                                                                          |
...
| **合计**        | **282** | **3369** | **0 失败** ✅（3367 passed + 2 skipped）                                                                                                                                    |
