...
> **产品**: 多模型开源智能编程终端
> **版本**: 2.17.0
> **最后更新**: 2026-08-26 — CRSI 完整覆盖闸（blast-radius 预检 fail-closed：自修改 proposal 必须声明触及的全部代码路径）+ 测试数对齐 1859
...
测试：1,859 测试（1857 passed + 2 skipped）
...
| **合计** | **174** | **1859** | **0 失败** ✅（1857 passed + 2 skipped）      |
