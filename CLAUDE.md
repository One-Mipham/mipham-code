...
测试：3,166 测试（3,164 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 78      | 1296     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| **合计**        | **264** | **3166** | **0 失败** ✅（3164 passed + 2 skipped）                                                                                                                                    |
