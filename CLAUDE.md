...
测试：3,388 测试（3,386 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 85      | 1344     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| **合计**        | **286** | **3388** | **0 失败** ✅（3386 passed + 2 skipped）                                                                                                                                    |
