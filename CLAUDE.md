...
测试：3,398 测试（3,396 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 87      | 1348     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| ui              | 21      | 243      | commands / input / config-wizard / loop / skill-doctor / ctrl-c                                                                                                             |
...
| providers       | 8       | 121      | anthropic / openai-compat / registry / llm-replay / bootstrap                                                                                                               |
| mcp             | 11      | 108      | client / transport / oauth / token-store / registry / instructions（含 2 skipped）                                                                                          |
...
| **合计**        | **288** | **3398** | **0 失败** ✅（3396 passed + 2 skipped）                                                                                                                                    |
