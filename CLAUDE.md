...
> **产品**: 多模型开源智能编程终端
> **版本**: 2.9.0
> **最后更新**: 2026-08-23 — Claude Code 2.1.206 借鉴落地 3 条（OAuth refresh 重试 + MCP request_timeout_ms + /cd 目录补全）+ 测试数对齐 1756
...
测试：1,756 测试（1754 passed + 2 skipped）
...
| **合计** | **152** | **1756** | **0 失败** ✅（1754 passed + 2 skipped）      |
