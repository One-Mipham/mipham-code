...
> **产品**: 多模型开源智能编程终端
> **版本**: 2.4.8
> **最后更新**: 2026-08-20 — 安全线排查：Grep/Glob 敏感文件掩码 + allow/deny 规则系统接线
...
测试：1,682 测试（1680 passed + 2 skipped）
...
| **合计** | **142** | **1682** | **0 失败** ✅（1680 passed + 2 skipped）      |
