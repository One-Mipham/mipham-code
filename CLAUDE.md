...
测试：3,390 测试（3,388 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 86      | 1346     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| **合计**        | **287** | **3390** | **0 失败** ✅（3388 passed + 2 skipped）                                                                                                                                    |
