...
测试：2,542 测试（2540 passed + 2 skipped，0 失败）
...
| daemon          | 33      | 193      | feishu / telegram / 钉钉 / 企业微信渠道 + session / auth / workspace-guard / logger + **引擎接线行为**（`engine-capabilities`）                                             |
...
| **合计**        | **228** | **2542** | **0 失败** ✅（2540 passed + 2 skipped）                                                                                                                                    |
