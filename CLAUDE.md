...
> **产品**: 多模型开源智能编程终端
> **版本**: 2.16.0
> **最后更新**: 2026-08-26 — v0.60.1 干净输出开箱默认（思考/调度通知/命令选择器静默，Bash 保留）+ 思考转储修复 + 测试数对齐 1855
...
测试：1,855 测试（1853 passed + 2 skipped）
...
| **合计** | **174** | **1855** | **0 失败** ✅（1853 passed + 2 skipped）      |
