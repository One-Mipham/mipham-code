...
测试：3,316 测试（3,314 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 81      | 1318     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| **合计**        | **277** | **3316** | **0 失败** ✅（3314 passed + 2 skipped）                                                                                                                                    |
