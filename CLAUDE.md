...
> **产品**: 多模型开源智能编程终端
> **版本**: 2.29.0
> **最后更新**: 2026-09-02 — CC 2.1.257 借鉴落地 — Bash 安全规则边界修复（#52+#44）+ 测试对齐 2170
...
测试：2,170 测试（2168 passed + 2 skipped）
...
| **合计** | **201** | **2170** | **0 失败** ✅（2168 passed + 2 skipped）      |
