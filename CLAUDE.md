...
测试：3,451 测试（3,449 passed + 2 skipped，0 失败）
...
| daemon          | 35      | 229      | feishu / telegram / 钉钉 / 企业微信渠道 + session / auth / auth-rotate / workspace-guard / logger + **引擎接线行为**（`engine-capabilities`）                               |
...
| **合计**        | **295** | **3451** | **0 失败** ✅（3449 passed + 2 skipped）                                                                                                                                    |
