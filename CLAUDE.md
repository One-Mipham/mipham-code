...
测试：2,800 测试（2798 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 73      | 1112     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
| tools           | 25      | 383      | bash / file / exec / skill / agent / scheduling / seam                                                                                                                      |
| daemon          | 34      | 209      | feishu / telegram / 钉钉 / 企业微信渠道 + session / auth / auth-rotate / workspace-guard / logger + **引擎接线行为**（`engine-capabilities`）                               |
...
| **合计**        | **244** | **2800** | **0 失败** ✅（2798 passed + 2 skipped）                                                                                                                                    |
