...
测试：3,378 测试（3,376 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 84      | 1341     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| providers       | 7       | 114      | anthropic / openai-compat / registry / llm-replay / bootstrap                                                                                                               |
...
| shared          | 11      | 98       | arg-validation / deleted-cwd / sanitize / graft / update-async                                                                                                              |
...
| **合计**        | **284** | **3378** | **0 失败** ✅（3376 passed + 2 skipped）                                                                                                                                    |
