...
测试：3,405 测试（3,403 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 88      | 1355     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| **合计**        | **289** | **3405** | **0 失败** ✅（3403 passed + 2 skipped）                                                                                                                                    |
