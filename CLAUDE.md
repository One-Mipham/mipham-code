...
> **产品**: 多模型开源智能编程终端
> **版本**: 2.8.0
> **最后更新**: 2026-08-21 — v0.53.0 发版（企业微信远程控制 + graft + /save + vim 修复）+ 测试数对齐 1748
...
测试：1,748 测试（1746 passed + 2 skipped）
...
| **合计** | **151** | **1748** | **0 失败** ✅（1746 passed + 2 skipped）      |
