...
测试：3,361 测试（3,359 passed + 2 skipped，0 失败）
...
| --------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| core            | 82      | 1329     | engine / context / permission / hooks / crsi / memory / instructions / paths 等                                                                                             |
...
| plugin          | 4       | 53       | claude-plugin / plugin-manager                                                                                                                                              |
...
| **合计**        | **281** | **3361** | **0 失败** ✅（3359 passed + 2 skipped）                                                                                                                                    |
